...
More info: https://uk.mathworks.com/help/stats/fitcdiscr.html
%}

% Climate Model Sim Crash Dataset Classification
...
datacell = textscan(fid, '%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f', 'Delimiter', delimiterIn, 'TreatAsEmpty', "?");
fclose(fid);
